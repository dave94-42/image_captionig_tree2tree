...
def main():
    ...
    parameters.append([300, 300])  # word embedding
    parameters.append([600, 600])  # hidden word size

    print("begin experiments")
    validation(input_train, target_train, input_val, target_val, parameters, FLAGS, image_tree.tree_def,
               sentence_tree.tree_def,
               name="parole_categoriche")
