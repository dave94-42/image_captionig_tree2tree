...
def get_encoder_decoder(emb_size, cut_arity, max_arity, max_node_count, max_depth, hidden_coeff,activation,
                        image_tree, sentence_tree):

    encoder = Encoder(tree_def=image_tree, embedding_size=emb_size, cut_arity=cut_arity, max_arity=max_arity,
    ...
    decoder = Decoder(tree_def=sentence_tree, embedding_size=emb_size, max_arity=max_arity,max_depth=max_depth,
